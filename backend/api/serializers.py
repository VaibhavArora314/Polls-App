...
class CreatePollSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'user', 'description',
                  'live_results', 'time_period', 'options')
...
class PollSerializer(serializers.ModelSerializer):
    ...
    time_left = serializers.SerializerMethodField(
        method_name='calculate_time_left')
    ...
    def calculate_time_left(self, poll):
        ...
        end_time = poll.created_at.replace(
            tzinfo=None) + timedelta(days=poll.time_period)
    ...
    class Meta:
        model = Poll
        fields = ('id', 'user', 'username', 'description',
                  'live_results', 'time_left', 'options', 'ended')
